...
client.on('ready', () => {
  ...
  client.guilds.cache.forEach((guild) => {
    if (!subs.includes(guild.id) && guild.id !== '1259151253762605128' && guild.id !== '1259151253762605128') {
      if (guild) {
        guild.leave().catch(err => { })
      }
    }
...
client.on('ready', async () => {
  ...
  client.guilds.cache.forEach((guild) => {
    if (!data.includes(guild.id) && guild.id !== `1259151253762605128` && guild.id !== `1259151253762605128` && guild.id !== `1259151253762605128`) {
      guild.leave().catch(err => { })
